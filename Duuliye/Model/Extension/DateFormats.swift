...
public let DATE_FOR_CHAT1: String = "MMM dd | hh:mm a" //"yyyy-MM-dd"
...
class DateFormater {
    ...
    class func getStringFromDateString(givenDate: String) -> String {
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone(name: "UTC") as TimeZone?
        self.sharedInstance.sharedDateFormat!.dateFormat = GLOBAL_APP_DATE_FORMAT //GLOBAL_DATE_FORMAT
        let date: NSDate = self.sharedInstance.sharedDateFormat!.date(from: givenDate)! as NSDate
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone.system
        self.sharedInstance.sharedDateFormat!.dateFormat = DATE_FOR_CHAT1 //DATE_FOR_CHAT
        return self.sharedInstance.sharedDateFormat!.string(from: date as Date)
    }
    
    class func getStringFromDateString_ExpireDate(givenDate: String) -> String {
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone(name: "UTC") as TimeZone?
        self.sharedInstance.sharedDateFormat!.dateFormat = GLOBAL_DATE_FORMAT
        let date: NSDate = self.sharedInstance.sharedDateFormat!.date(from: givenDate)! as NSDate
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone.system
    ...
    class func getTimeStringFromDateString(givenDate: String) -> String {
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone(name: "UTC") as TimeZone?
        self.sharedInstance.sharedDateFormat!.dateFormat = GLOBAL_DATE_FORMAT
        let date: NSDate = self.sharedInstance.sharedDateFormat!.date(from: givenDate)! as NSDate
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone.system
    ...
    class func getStringFromDateStringNew(givenDate: String) -> String {
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone(name: "UTC") as TimeZone?
        self.sharedInstance.sharedDateFormat!.dateFormat = DATE_FOR_CHAT1
        let date: NSDate = self.sharedInstance.sharedDateFormat!.date(from: givenDate)! as NSDate
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone.system
        self.sharedInstance.sharedDateFormat!.dateFormat = DATE_FOR_CHAT
        return self.sharedInstance.sharedDateFormat!.string(from: date as Date)
    ...
    class func generateDateWithFormat2FromGivenDatestring(strDate: String) -> String {
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone(name: "UTC") as TimeZone? //NSTimeZone.system
        self.sharedInstance.sharedDateFormat!.dateFormat = GLOBAL_DATE_FORMAT
        let date: NSDate = self.sharedInstance.sharedDateFormat!.date(from: strDate)! as NSDate
        self.sharedInstance.sharedDateFormat!.dateFormat = DATE_TIME_12HRS_FORMAT_3 //DATE_TIME_12HRS_FORMAT_2
        let dt: String = self.sharedInstance.sharedDateFormat!.string(from: date as Date)
        return "\(dt)"
    }
...
extension Date {
    ...
    static func getCurrentDate(withFormat: String) -> String {  // "dd/MM/yyyy HH:mm:ss"
